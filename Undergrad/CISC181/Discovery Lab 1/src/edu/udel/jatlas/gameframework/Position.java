...
public class Position extends Component3d 
{
    ...
    /**
     * Mutates this Position by adding the position with the scaling of the given vector.
    ...
    {
    	DirectionVector temp = new DirectionVector(v.getX(), v.getY(), v.getZ());
    	temp.scale(scaling);
        this.setX( temp.getX() + this.getX() );
        this.setY( temp.getY() + this.getY() );
        this.setZ( temp.getZ() + this.getZ() );
    }
}
