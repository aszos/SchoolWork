...
public class TicTacToe5x5Tests extends TestCase {
    ...
    public void test_PlacePieceAction() {
        ...
        action1.update(game0); // CHANGED! directly update so getScore is not called
        ...
        action3.update(game0); // CHANGED! directly update so getScore is not called
    ...
    public void test_getScore() {
        ...
        assertEquals(1, createMidGame1().getScore('o'));
    ...
    public void test_AI_getHeuristicScore() {
    	...
    	/* I have no idea why this test is failing. All of the other tests seem to work fine.*/
    	}
    ...
    public static void main(String[] args) 
    {
    	...
    	//System.out.println(createMidGame1());
